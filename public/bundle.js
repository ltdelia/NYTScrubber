				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'a',
								{ className: 'navbar-brand', href: '#/search' },
								'Search'
							),
							React.createElement(
								'a',
								{ className: 'navbar-brand', href: '#/saved' },
								'Saved Articles'
							)
						)
					)
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement("input", { type: "text", className: "form-control", id: "topic", value: this.state.value, onChange: this.handleChange, required: true }),
									React.createElement(
										"h4",
										null,
										"Start Year"
